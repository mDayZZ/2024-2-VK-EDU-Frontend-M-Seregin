...
| **last_message**      | `string`   | последнее сообщение в чате, может быть `null`                              |
| **last_message_time** | `string`   | время последнего сообщения в формате `YYYY-MM-DD HH:MM`, может быть `null` |
